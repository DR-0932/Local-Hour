      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="grid gap-4 sm:gap-5 md:grid-cols-3">
          ...
          >
            ...
            <p className="mt-5 max-w-xl text-base leading-7 text-neutral-800 sm:text-lg sm:leading-8 md:mt-6">
              We create welcoming spaces for people of all age groups
              to experience something different, meet new people, and
              build genuine connections along the way.
            </p>
